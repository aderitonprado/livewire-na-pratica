<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <div class="w-full mx-auto text-right mb-4">
        <a href="{{route('plans.create')}}" class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-red py-1 px-2 rounded">Criar Plano</a>
    </div>
